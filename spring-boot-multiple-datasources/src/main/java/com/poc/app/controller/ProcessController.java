...
public class ProcessController {
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "Member Details saved successfully into database")})
	...
	@ApiResponses({ @ApiResponse(code = 200, message = "Card Details saved successfully into database")})
